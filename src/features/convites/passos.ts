...
export const PASSOS_CONVITE = [
  {
    ...
    curto: "Os seus dados",
    descricao: "Identificação, contacto e morada pessoal associados à sua conta.",
  },
  {
    n: 2,
    chave: "profissionais",
    titulo: "Dados profissionais",
    curto: "Dados profissionais",
    descricao:
      "Cargo e dados de inscrição na Ordem dos Advogados, quando aplicável.",
  },
  {
    n: 3,
    chave: "documentos",
    titulo: "Documentos",
    curto: "Documentos",
    descricao: "Documento de identificação e comprovativo profissional.",
  },
  {
    n: 4,
    chave: "rgpd",
    titulo: "Proteção de dados e sigilo",
    curto: "Proteção de dados e sigilo",
    descricao:
      "Informação sobre proteção de dados e compromisso de sigilo profissional.",
  },
  {
    n: 5,
    chave: "termos",
    ...
    descricao:
      "Termos e Condições da sociedade a aceitar para aceder à plataforma.",
  },
  {
    n: 6,
    chave: "conta",
    titulo: "Criar conta",
    curto: "Criar conta",
    descricao: "Definição da palavra-passe para ativação da sua conta.",
  },
] as const;
