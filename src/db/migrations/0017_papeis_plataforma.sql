...
BEGIN
  IF EXISTS (
    ...
    -- A 0016 (portais) criou `convite_utilizador.papel` do tipo antigo, com o
    -- DEFAULT 'advogado'. Tem de ser reconvertida como a do `utilizador`, senão
    -- o DROP TYPE abaixo falha com "other objects depend on it".
    ALTER TABLE "convite_utilizador" ALTER COLUMN "papel" DROP DEFAULT;
    ALTER TABLE "convite_utilizador"
      ALTER COLUMN "papel" TYPE "public"."papel_utilizador"
      USING (
        CASE "papel"::text
          WHEN 'admin' THEN 'society_admin'
    ...
    ALTER TABLE "convite_utilizador" ALTER COLUMN "papel" SET DEFAULT 'utilizador'::"public"."papel_utilizador";
